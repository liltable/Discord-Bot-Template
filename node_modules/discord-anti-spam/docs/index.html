...
<p>A simple module with quick setup and different options to implement anti-spam features in your bot.
<strong>This version of the package will only support discord.js v13</strong></p>
<h2>Installation</h2>
...
<h2>Example (As a direct copy template without explanations)</h2>
<pre class="prettyprint source lang-js"><code>const antiSpam = new AntiSpam({
  warnThreshold: 3,
  muteThreshold: 4,
  kickThreshold: 7,
  banThreshold: 7,
...
<h2>Multiple Guild Example</h2>
<p>Because of a new update, you may now have multiple guilds having their own options. You will need to store their options in a database or something similar to avoid loss of settings.</p>
<pre class="prettyprint source lang-js"><code>const Discord = require(&quot;discord.js&quot;);
const client = new Discord.Client({
  intents: [Discord.Intents.FLAGS.GUILDS, Discord.Intents.FLAGS.GUILD_MESSAGES],
});
